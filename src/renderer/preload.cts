 ...
 * isolated world and hands it exactly four sends — start a sync, store a
 * password, set the plan size and set the plan length — and nothing else: no
 * `ipcRenderer`, no channel names, no way to reach a channel this file does not
 * name.
 *
